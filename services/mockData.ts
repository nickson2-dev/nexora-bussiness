...
export const mockCategories: Category[] = [
  ...
  { 
    name: 'Books', 
    imageUrl: 'https://i.postimg.cc/L5hZWvXK/download.jpg',
    subcategories: [
      { 
        name: 'Fiction',
        subcategories: [
  ...
  { 
    ...
    imageUrl: 'https://i.postimg.cc/m2C6pSF6/Ustensiles-Essentiels-de-cuisine-Healthy-Alie.jpg',
    subcategories: [
      { 
        name: 'Home & Kitchen',
        subcategories: [
  ...
  { 
    name: 'Fashion', 
    imageUrl: 'https://i.postimg.cc/15wY7Kqh/Prestige-Premium-Poloshirt-fur-Herren-Khaki-L.jpg',
    subcategories: [
...
export const mockProducts: Product[] = [
  // Existing Products (updated with new fields)
  {
    ...
    images: ['https://i.postimg.cc/kXKhYybr/JBL-Quantum-800-Wireless-Over-Ear-Performance-Gaming-Headset-Active-Noise-PB.jpg', 'https://i.postimg.cc/QdssfCV7/34-99-PHILIPS-H3209-Wireless-Headphones-On-Ear-Bluetooth-Headphones.jpg', 'https://i.postimg.cc/0yxxVjrw/Audionic-Headphone-110-Immersive-Sound-with-Deep-Bass-Comfortable-Design-for-Long-Lasting-Wear.jpg'],
    rating: 4.8,
    reviewCount: 1250,
    stock: 50,
    isBestseller: true,
  ...
  },
  {
    ...
    images: ['https://i.postimg.cc/26pxW1zf/Amazon-Echo-4th-Gen-Smart-Speaker.jpg', 'https://i.postimg.cc/k4ryS2nm/Echo-Dot-4th-Gen-Smart-Speaker.jpg'],
    rating: 4.5,
    reviewCount: 890,
    stock: 120,
    isTrending: true,
  ...
  },
  {
    ...
    price: 12.50,
    category: 'Fiction',
    images: ['https://i.postimg.cc/FRtxSY9r/The-Alchemyst-The-Secrets-of-the-Immortal-Nicholas-Flamel.jpg', 'https://picsum.photos/seed/book2/600/600'],
    rating: 4.9,
    reviewCount: 25000,
    stock: 200,
    isBestseller: true,
  ...
  },
  {
    ...
    images: ['https://i.postimg.cc/V6yFtJYM/Ultimate-Guide-to-Automatic-Drip-Coffee-Makers.jpg', 'https://i.postimg.cc/W3R7Zd24/Kenmore-Espresso-Machine-Barista-Style-Coffee-Maker-with-Grinder-Milk-Frother.jpg'],
    rating: 4.7,
    reviewCount: 450,
    stock: 30,
    isTrending: true,
  ...
  },
  {
    ...
    images: ['https://i.postimg.cc/KzX5T1Z7/Temu-Shop-like-a-Billionaire.jpg', 'https://i.postimg.cc/G20jD4cG/Bird-in-Bag-Adventure-Ready-Backpack-for-Travel-and-Exploration-Grey-one-size.jpg'],
    rating: 4.6,
    reviewCount: 670,
    stock: 80,
  ...
  },
  {
    ...
    price: 24.99,
    category: 'Toys & Games',
    images: ['https://i.postimg.cc/Jnb55Rnj/1000-Teile-for-Galaxy-Puzzle-Kosmische-Herausforderung-mit-SATURN-Nebel-Sternen-Fortgeschritt.jpg'],
    rating: 4.8,
    reviewCount: 320,
    stock: 150,
  ...
  },
  {
    ...
    images: ['https://i.postimg.cc/fLxffML3/download-1.jpg'],
    rating: 4.9,
    reviewCount: 980,
    stock: 100,
    isBestseller: true,
  ...
  },
  {
    ...
    images: ['https://i.postimg.cc/xCK339C5/20190529-Praktisch-handig.jpg'],
    rating: 4.9,
    reviewCount: 35000,
    stock: 300,
    isTrending: true,
  ...
  },
  {
    ...
    category: "Men's Fashion",
    images: ['https://i.postimg.cc/vBWttGBz/Mark-Men-s-Black-Harrington-Lambskin-Leather-Jacket-Handmade-Classic-Jacket-With-Shirt-Collar-Et.jpg', 'https://i.postimg.cc/qR8xxpRx/Genuine-Leather-Biker-Jacket-Slim-Fit-Men-s-Fashion.jpg'],
    rating: 4.7,
    reviewCount: 310,
    stock: 45,
    reviews: [],
  ...
  },
  {
    ...
    price: 35.99,
    category: 'Home Decor',
    images: ['https://i.postimg.cc/vBWttGBP/5M-WS2811-5050-150-300-LED-Strip-Light-RGB-Dream-Color-Pixel-Addressable-DC12V.jpg'],
    rating: 4.5,
    reviewCount: 1500,
    stock: 200,
    reviews: [],
  ...
  },
  {
    ...
    price: 299.00,
    category: 'Sports & Outdoors',
    images: ['https://i.postimg.cc/ydFyy7d5/Czmdzh-Adjustable-Dumbbells-Weight-Set-Dumbbell-Weights-Exercise-Fitness-Equipment-w-4-Spinlock-C.jpg'],
    rating: 4.8,
    reviewCount: 750,
    stock: 25,
    isBestseller: true,
  ...
  },
  {
    ...
    price: 49.99,
    category: 'Computer Accessories',
    images: ['https://i.postimg.cc/J4ZdYQBf/LENRUE-Bluetooth-Speaker-Mini-Portable-Wireless-Outdoor-Speaker-with-RGB-Lights-360-Surround.jpg', 'https://picsum.photos/seed/speaker2/600/600'],
    rating: 4.7,
    reviewCount: 2200,
    stock: 150,
    reviews: [],
